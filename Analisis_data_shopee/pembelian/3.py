...
print(df)
hasil = df.groupby('customer_name')['salesman_id'].count().reset_index(name='jumlah').sort_values('jumlah', ascending=False).reset_index(drop=True)
hasil = hasil[hasil['jumlah'] > 1]
print(hasil)