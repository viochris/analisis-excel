...
df_avg_reservasi_harian = df_reservasi_perhari.groupby(pd.Grouper(key='arrival_date', freq='W'))['total'].mean().reset_index()
print(df_avg_reservasi_harian)

plt.figure(figsize=(10,4))
sns.lineplot(data=df_avg_reservasi_harian, x='arrival_date', y='total')
plt.show()