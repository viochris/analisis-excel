...
print(tabel_akhir)
print()
tabel_apriori = apriori(tabel_akhir, min_support=0.015, use_colnames=True).sort_values('support', ascending=False)
print(tabel_apriori)
print()
...
hasil_akhir.to_excel('tabel akhir.xlsx', index=False)