...
print(tabel1)
print()
tabel2 = tabel.groupby('Customer Code')[['BOX QTY', 'TOTAL WEIGHT']].sum().reset_index()
print(tabel2)


tabel_123 = pd.merge(tabel1[['Customer Code', 'CUSTOMER NAME', 'Tax']], tabel2, left_on='Customer Code', right_on='Customer Code', how='inner')
print(tabel_123)
...
def total(x,y,z):
    ...
    # z = tabel_123['Pajak']
    return x+y+((x+y)*z)
tabel_123.loc[0:14,'Total'] = total(tabel_123['Price Total Qty Box'], tabel_123['Price Total Weight'], tabel_123['Pajak'])
print(tabel_123)
